...
import org.bobcatrobotics.GameSpecific.Rebuilt.RebuiltFieldConstants;

public class AllianceFlipUtil {
  public static double applyX(double x) {
    return shouldFlip() ? RebuiltFieldConstants.fieldLength - x : x;
  }

  public static double applyY(double y) {
    return shouldFlip() ? RebuiltFieldConstants.fieldWidth - y : y;
  }
